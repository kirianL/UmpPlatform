                  ...
                  >
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center gap-2.5 min-w-0">
                        <div className="flex size-8 sm:size-9 items-center justify-center font-mono text-xs sm:text-sm font-bold text-accent-11 bg-accent-3 rounded-full shrink-0">
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-2 border-t border-grayscale-3 dark:border-grayscale-4 text-xs font-mono">
                    <div>
                      ...
                      {selectedFichaActor.phone ? (
                        ...
                        <span className="font-bold text-grayscale-12 block">No especificado</span>
                      )}
                    </div>
                    <div>
                      <span className="text-grayscale-9 text-[10px] uppercase block">
